...
public class BlockCustomPressurePlate extends BlockPressurePlate {
    public BlockCustomPressurePlate(CustomBlockInfo info) {
        super(getMaterialFromName(info.material), getMaterialFromName(info.material) == Material.WOOD ? Sensitivity.EVERYTHING : Sensitivity.MOBS);
