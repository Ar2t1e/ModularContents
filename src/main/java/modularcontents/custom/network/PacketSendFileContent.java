...
public class PacketSendFileContent implements IMessage {
    public String packName = "";
    public String filePath = "";
    public String jsonContent = "";

    public PacketSendFileContent() {}

    public PacketSendFileContent(String packName, String filePath, String jsonContent) {
